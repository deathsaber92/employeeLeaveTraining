...
namespace EmployeeLeaveTraining.Data.Migrations
{
    ...
    [Migration("20200427180112_AddedNumbersOfDays")]
    partial class AddedNumbersOfDays
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeLeaveTraining.Data.LeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeLeaveTraining.Data.LeaveHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeLeaveTraining.Data.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeLeaveTraining.Models.LeaveTypeViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeLeaveTraining.Data.Employee", b =>
                {
            ...
            modelBuilder.Entity("EmployeeLeaveTraining.Data.LeaveAllocation", b =>
                {
                    b.HasOne("EmployeeLeaveTraining.Data.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("EmployeeLeaveTraining.Data.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeLeaveTraining.Data.LeaveHistory", b =>
                {
                    b.HasOne("EmployeeLeaveTraining.Data.Employee", "ApprovedBy")
                        .WithMany()
                    ...
                    b.HasOne("EmployeeLeaveTraining.Data.Employee", "RequestingEmployee")
                        .WithMany()
